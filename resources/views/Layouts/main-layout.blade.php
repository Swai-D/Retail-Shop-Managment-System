...
<div class="wrapper">
      ...
      <nav class="mt-2">
        ...
        <li class="nav-item menu-open">
            ...
            <ul class="nav nav-treeview">
              ...
              <li class="nav-item">
                <a href="/Maswai-Shop-Management-System/Stock-Blade-Files/daily_sells_sheet" class="nav-link ">
                  <i class="far fa-circle nav-icon"></i>
              ...
              <li class="nav-item">
                <a href="/Maswai-Shop-Management-System/Stock-Blade-Files/sales_over_view" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Shop Over-View</p>
                </a>
              </li>
        ...
        <li class="nav-item">
          ...
          <ul class="nav nav-treeview">
            <li class="nav-item">
              <a href="/Maswai-Shop-Management-System/Wakala-Blade-Files/wakala_form  " class="nav-link">
                <i class="far fa-circle nav-icon"></i>
                <p>Forms</p>
              </a>
            </li>
  ...
  <footer class="main-footer">
    <strong>Copyright &copy; <a href="#">Odessa lab, Arusha </a>. {{date('M, Y')}} </strong>
    All rights reserved.
...
<script type="text/javascript">
  $(document).ready(function(){
    $('#add_new_row').on('click', function(){
      ...
      html += '<td><input type="number" name="quantity[]"  class="form-control form-control-line" style="height:35px; border-radius:5px;"></td>';
      html += '<td><input type="text" name="description[]"  class="form-control form-control-line" style="height:35px border-radius:5px;"></td>';
      html += '<td><input type="number" name="rate[]" class="form-control form-control-line" style="height:35px border-radius:5px;"></td>';
      html += '<td><input type="number" name="profoma[]" class="form-control form-control-line" style="height:35px border-radius:5px;"></td>';
