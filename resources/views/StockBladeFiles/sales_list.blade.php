              ...
              <div class="card-body">
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  <tbody>
                    ...
                    @foreach($sold_items as $item_sold => $value)
                      ...
                      <tr>
                        ...
                        <td><b>{{number_format($value->sells)}}</b></td>
                  ...
                  <tr>
                    ...
                    <th><span style="color:red; font-size:30px;">{{number_format($total)}}</span> &nbsp;&nbsp;  <span style="color:blue;">{{number_format($profit)}}</span>  </th>
