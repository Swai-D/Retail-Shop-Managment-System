          ...
          <div class="col-12">
            ...
            <div class="card">
              ...
              <div class="card-body">
                ...
                @foreach($StockTableList as $item)
                  <tr>
                    ...
                    @if($item->profit < 0 )
                      <td style="color:red;">{{$item->profit}} (loss)</td>
                    @else
                      <td>{{$item->profit}}</td>
                    @endif
                    <td>{{$item->pices}}</td>
                    <td>
                      <div class="row">
                        <div class="col-6">
                          <a href="/Maswai-Shop-Management-System/Stock-Blade-Files/update_stock/{{$item->id}}" class="btn btn-danger btn-sm"><i class="fa fa-edit"></i></a>
